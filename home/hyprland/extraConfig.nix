...
: let
  config = ''
    ...
    windowrulev2 = opacity 0.9 override 0.8 override, class:com.mitchellh.ghostty
    ...
    windowrulev2 = opacity 1.0 override 0.85 override, class:jetbrains-rustrover
    windowrulev2 = opacity 1.0 override 0.85 override, class:Anki
    windowrulev2 = opacity 1.0 override 0.85 override, class:org.qbittorrent.qBittorrent
